            ...
            <div class="col-lg-12 col-sm-12 col-12 main-section">
                <div class="dropdown">
                    <button type="button" class="btn btn-info" data-toggle="dropdown">
                        <i class="fa fa-shopping-cart" aria-hidden="true"></i> <a href="{{ route('cart.index') }}">Cos</a>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="row cart-detail">
                            <div class="col-lg-8 col-sm-8 col-8 cart-detailproduct">
                                <p>{{ $details['nume'] }}</p>
                                <span class="pret text-info"> ${{ $details['pret'] }}</span> <span class="count"> Cantitate:{{ $details['quantity'] }}</span>
                            </div>
                        </div>
                        @endforeach
                        @endif
