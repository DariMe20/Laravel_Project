...
$details['pret'] * $details['quantity'] }}</td>
 <td class="actions" data-th="">
 <button class="btn btn-info btn-sm update-cart" dataid="{{ $id }}"><i class="fa fa-refresh"></i>Update</button>
...
data-id="{{ $id }}"><i class="fa fa-trash-o"></i>-</button>
 ...
 <tr>
 <td><a href="{{ url('tickets/') }}" class="btn btn-warning"><i class="fa
